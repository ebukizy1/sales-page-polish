...
const appCss = "/assets/styles-DKRhZv25.css";
...
const $$splitComponentImporter$3 = () => import("./offers-D8eNXLC6.mjs");
const Route$3 = createFileRoute("/offers")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "All active solar street light bundles and discounts. Pay on delivery nationwide."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin-bSITkBwH.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-CC0I3qJW.mjs");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Light your whole compound — without NEPA. 25,000mAh, 5-year warranty, pay on delivery anywhere in Nigeria."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./product._slug-BP9hdNIU.mjs");
const Route = createFileRoute("/product/$slug")({
  head: ({
    ...
    meta: [{
      ...
      name: "description",
      content: "Check out this custom solar street light bundle. Pay on delivery nationwide."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const OffersRoute = Route$3.update({
  id: "/offers",
  path: "/offers",
